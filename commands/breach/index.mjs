...
const texts = {
    es: { failure:'[:: ERROR FATAL: NETWATCH DETECTADO ::]\n CÓDIGO: 0xDEAD-N3T  \n >> BRECHA CRÍTICA BLOQUEADA <<  \n [0xA77F3] ACCESO DENEGADO.  \n [0x4CC355] REGISTRO DE ACTIVIDAD CREADO.  \n [0xB4D10] SISTEMA BLOQUEADO. TODOS LOS PRIVILEGIOS REVOCADOS. \n\nPRESIONA CUALQUIER TECLA PARA SALIR...', title1: "Acceso a la Red", title2: "Recopilar Datos", title3: "Simulación de Salida", desc1: "Infiltra el sistema para obtener acceso a la red.", desc2: "Recopila datos críticos de los registros del sistema.", desc3: "Ejecuta la simulación de salida para salir del sistema." },
